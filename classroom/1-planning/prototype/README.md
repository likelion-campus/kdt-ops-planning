...
| AI 퀴즈 | 3탭 — 오늘의 퀴즈·오답노트·보충(다중 날짜·하루 10회 한도) | 3탭 — **퀴즈 발행하기**(슬롯 리스트·상단 고정 액션·AI 퀴즈 생성·임시저장/예약발행/즉시발행·문항별 AI 문항 생성)·발행된 퀴즈(오답률·분포)·보충 히트맵(푼 날짜·Max 10) |
...
| 프로젝트 | 4탭 — 문제·제출하기·제출 리스트·받은 피드백 (제출 폼 외부발행 토글 제거) | 3탭 — 문제·제출현황·피드백(기간만 활성) |
